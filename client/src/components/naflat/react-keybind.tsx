// forked from https://github.com/UnicornHeartClub/react-keybind/blob/master/src/index.tsx.
// should be replaced to package dependency once issues are resolved.
